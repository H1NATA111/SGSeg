...
from sgseg.third_party import clip
from sgseg.third_party import imagenet_templates
...
class sgsegPredictor(nn.Module):
    @configurable
    def __init__(
        self,
        *,
    ...
    def forward(self, x, vis_guidance, gt, prompt=None, gt_cls=None):
        ...
        out = self.transformer(x, text, vis, gt)
        return out
