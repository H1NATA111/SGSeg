...
from detectron2.utils.analysis import flop_count_operators, parameter_count_table, parameter_count
import torch
...
def main(args):
    ...
    if args.eval_only:
        ...
        #flop = flop_count_operators(model, inputs=[{"image": torch.randn(1, 3, 224, 224)}])
        #parameter = parameter_count_table(model)
        #parameter2 = parameter_count(model)
        #print(flop)
        #print(parameter)
        #print(parameter2)
